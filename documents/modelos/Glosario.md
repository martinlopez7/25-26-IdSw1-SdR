...
| **Exámen** | Documento de evaluación de la asignatura tipo test que un docente genera instroduciendo varios parámetros a partir de una batería de preguntas previamente preparada. |
