...
| **Creado → Asignado** | Transición |El examen se asigna formalmente a los estudiantes de la asignatura mediante la vinculación del modelo de corrección correspondiente a cada alumno y se guarda un hash único del modelo de corrección asignado a cada estudiante. De este modo, se asegura que no haya cambios en las respuestas o en los criterios de corrección. |
